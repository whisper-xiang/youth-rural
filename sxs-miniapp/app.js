...
App({
  ...
  hasPermission(permission) {
    ...
    const permissions = {
      ...
      'result.view': ['student', 'teacher', 'college_admin', 'school_admin', 'expert'],
      // 评优管理
      ...
      'notice.view': ['student', 'teacher', 'college_admin', 'school_admin', 'expert']
    };
  ...
  getRoleModules() {
    const role = this.globalData.role;
    const allModules = [
      { key: 'apply', name: '活动申报', desc: '创建和管理申报项目', url: '/pages/activity/apply-list', icon: 'icon-apply' },
      { key: 'approve', name: '审批管理', desc: '审核项目申报材料', url: '/pages/approve/list', icon: 'icon-approve' },
      { key: 'progress', name: '进度跟踪', desc: '上传和查看活动进展', url: '/pages/progress/list', icon: 'icon-progress' },
      { key: 'result', name: '成果管理', desc: '提交和浏览活动成果', url: '/pages/result/list', icon: 'icon-result' },
      { key: 'evaluate', name: '评优管理', desc: '项目评审与打分', url: '/pages/evaluate/list', icon: 'icon-evaluate' },
      { key: 'notice', name: '通知公告', desc: '查看最新通知', url: '/pages/notice/list', icon: 'icon-notice' }
    ];
    ...
    const roleModules = {
      ...
      school_admin: ['apply', 'approve', 'progress', 'result', 'evaluate', 'notice'],
