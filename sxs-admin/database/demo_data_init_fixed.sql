...
-- 草稿状态项目
INSERT INTO project (
  id, project_no, title, category, target_area, start_date, end_date, 
  leader_id, teacher_id, college_id, description, plan, expected_result,
  status, created_at
) VALUES 
(1, 'PRJ2026001', '乡村振兴调研计划（草稿）', '乡村振兴', '湖南省长沙市望城区', 
...
(5, '教育帮扶暖童心', '教育帮扶', '贵州省黔东南州', 
 '2026-06-20', '2026-07-10', 7, 12, 2,
 '赴偏远地区开展教育帮扶活动，为当地儿童提供教育支持和关爱。',
 '第一周：开展教学活动，了解教育现状\n第二周：组织文体活动，进行家访调研',
 '完成教育帮扶报告，建立长期帮扶机制',
 'approved', NOW() - INTERVAL 5 DAY),

(6, '非遗文化保护行动', '文化保护', '云南省大理州', 
 '2026-06-15', '2026-06-30', 8, 13, 3,
 '探访非物质文化遗产传承人，记录传统技艺，开展文化保护宣传。',
 '第一周：寻访非遗传承人，记录技艺\n第二周：开展保护宣传活动，制作纪录片',
 '完成非遗调研报告，制作宣传纪录片',
 'approved', NOW() - INTERVAL 7 DAY);
...
(10, '乡村振兴调研实践', '乡村振兴', '湖南省长沙市望城区', 
 '2026-05-01', '2026-05-15', 3, 8, 1,
 '深入农村基层，调研乡村振兴战略实施情况，了解农村发展现状与需求。',
 '第一周：实地走访调研，收集一手资料\n第二周：数据整理与分析，撰写调研报告',
 '完成调研报告一份，提出乡村振兴建议方案',
 'closed', NOW() - INTERVAL 30 DAY, NULL);
